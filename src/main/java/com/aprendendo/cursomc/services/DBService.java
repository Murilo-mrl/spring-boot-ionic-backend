...
import com.aprendendo.cursomc.domain.PagamentoComCartao;
import com.aprendendo.cursomc.domain.Pedido;
import com.aprendendo.cursomc.domain.Produto;
import com.aprendendo.cursomc.domain.enums.EstadoPagamento;
import com.aprendendo.cursomc.domain.enums.Perfil;
import com.aprendendo.cursomc.domain.enums.TipoCliente;
import com.aprendendo.cursomc.repositories.CategoriaRepository;
...
import com.aprendendo.cursomc.repositories.EstadoRepository;
import com.aprendendo.cursomc.repositories.ItemPedidoRepository;
import com.aprendendo.cursomc.repositories.PagamentoRepository;
import com.aprendendo.cursomc.repositories.PedidoRepository;
import com.aprendendo.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "kyraxd3@gmail.com", "36378912377", TipoCliente.PESSSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "client2@gmail.com", "85044260096", TipoCliente.PESSSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93888321", "3425625"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "28177012", cli1, c2);
